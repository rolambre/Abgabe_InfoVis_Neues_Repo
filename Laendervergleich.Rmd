...
## So steht Deutschland im Vergleich zu seinen Nachbarländern dar
...
covid_data %>%
  ...
  labs(title = "Die Anzahl einfach und vollständig geimpfter Personen in Deutschland\nund seinen Nachbarländern steigt seit Anfang des Jahres 2021 stark an",
              ...
              caption = "Quelle: Our World in Data")
```
##### Deutschland und seine Nachbarländer weisen einen sehr ähnlichen Verlauf hinsichtlich der Anzahl der geimpften Personen auf. Seit Anfang 2021 steigt die Anzahl er geimpften Personen stark an. In Deutschland und seinen Nachbarländern sind zwischen 30 und 40 % der jeweiligen Bevölkerung vollständig geimpft.
